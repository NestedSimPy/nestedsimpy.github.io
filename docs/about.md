...
NestedSimPy is released under the [MIT License][license] — the same permissive
license used by [SimPy](https://simpy.readthedocs.io/).

The example models under `simpy_examples/` are adapted from the official
[SimPy examples](https://simpy.readthedocs.io/en/latest/examples/index.html),
© 2013 Ontje Lünsdorf and Stefan Scherfke, and are used under the MIT License.
