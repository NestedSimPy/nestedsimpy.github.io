...
def run_one_to_one() -> None:
    """Run the one-producer/one-consumer communication scenario."""
...
def run_one_to_many() -> None:
    """Run the broadcast communication scenario with two consumers."""
